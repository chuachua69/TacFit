...
-- 6. Seed the global catalog ----------------------------------------------
-- SEED:BEGIN — GENERATED from client/src/lib/exerciseCatalog.js by scripts/gen-seed.mjs. DO NOT EDIT BY HAND.
-- 58 exercises. Regenerate: node scripts/gen-seed.mjs
...
values
  ...
  ('db-bench-press', 'Dumbbell Bench Press', 'Chest', '{Triceps,Shoulders}', 'Compound', 'Dumbbell', 3, 48),
  ('pushup', 'Push-Up', 'Chest', '{Triceps,Shoulders}', 'Compound', 'Bodyweight', 2, 24),
  ('chest-fly', 'Dumbbell Chest Fly', 'Chest', '{}', 'Isolation', 'Dumbbell', 1, 24),
  ('bb-row', 'Barbell Row', 'Back', '{Biceps,Core}', 'Compound', 'Barbell', 4, 48),
  ('lat-pulldown', 'Lat Pulldown', 'Back', '{Biceps}', 'Compound', 'Machine', 2, 24),
  ('cable-row', 'Cable Seated Row', 'Back', '{Biceps}', 'Compound', 'Cable', 2, 24),
  ('inverted-row', 'Inverted Row', 'Back', '{Biceps,Core}', 'Compound', 'Bodyweight', 1, 24),
  ('db-shoulder-press', 'Dumbbell Shoulder Press', 'Shoulders', '{Triceps}', 'Compound', 'Dumbbell', 3, 48),
  ('cable-lateral-raise', 'Cable Lateral Raise', 'Shoulders', '{}', 'Isolation', 'Cable', 1, 24),
  ('leg-press', 'Leg Press', 'Quads', '{Hamstrings,Calves}', 'Compound', 'Machine', 4, 48),
  ('goblet-squat', 'Goblet Squat', 'Quads', '{Core}', 'Compound', 'Kettlebell', 2, 24),
  ('bulgarian-split-squat', 'Bulgarian Split Squat', 'Quads', '{Hamstrings,Core}', 'Compound', 'Dumbbell', 3, 48),
  ('leg-extensions', 'Leg Extension', 'Quads', '{}', 'Isolation', 'Machine', 2, 24),
  ('db-rdl', 'Dumbbell Romanian Deadlift', 'Hamstrings', '{Back,Core}', 'Compound', 'Dumbbell', 3, 48),
  ('leg-curl', 'Lying Leg Curl', 'Hamstrings', '{}', 'Isolation', 'Machine', 2, 24),
  ('hip-thrust', 'Barbell Hip Thrust', 'Hamstrings', '{Quads}', 'Compound', 'Barbell', 4, 48),
  ('preacher-curl', 'Preacher Curl', 'Biceps', '{}', 'Isolation', 'Barbell', 1, 24),
  ('cable-curl', 'Cable Bicep Curl', 'Biceps', '{}', 'Isolation', 'Cable', 1, 24),
  ('overhead-tricep-ext', 'Overhead Tricep Extension', 'Triceps', '{}', 'Isolation', 'Dumbbell', 1, 24),
  ('skull-crusher', 'Skull Crusher', 'Triceps', '{}', 'Isolation', 'Barbell', 2, 24),
  ('ab-wheel', 'Ab Wheel Rollout', 'Core', '{}', 'Isolation', 'Bodyweight', 2, 24),
  ('kb-swing', 'Kettlebell Swing', 'Cardio', '{Hamstrings,Core}', 'Compound', 'Kettlebell', 3, 24),
  ('burpees', 'Burpee', 'Cardio', '{Chest,Quads,Core}', 'Compound', 'Bodyweight', 3, 24),
  ('zercher-squat', 'Zercher Squat', 'Quads', '{Back,Core}', 'Compound', 'Barbell', 4, 48),
  ('zercher-carry', 'Zercher Carry', 'Core', '{Back,Shoulders}', 'Compound', 'Barbell', 4, 48),
  ('zercher-deadlift', 'Zercher Deadlift', 'Hamstrings', '{Back,Core}', 'Compound', 'Barbell', 5, 72),
  ('sandbag-carry', 'Sandbag Bear Hug Carry', 'Core', '{Back,Chest}', 'Compound', 'Bodyweight', 3, 24),
  ('kb-snatch', 'Kettlebell Snatch', 'Cardio', '{Shoulders,Core}', 'Compound', 'Kettlebell', 3, 24),
  ('kb-goblet-carry', 'Kettlebell Goblet Carry', 'Core', '{Quads}', 'Compound', 'Kettlebell', 2, 24),
  ('suitcase-carry', 'Kettlebell Suitcase Carry', 'Core', '{Back}', 'Compound', 'Kettlebell', 2, 24)
